            ...
            draw: function(e) {
                ...
                function o(e) {
                    for (var t = 0; t < p.locations.length; t++) {
                        ...
                        r.className = "row-heading", r.textContent = htmlUnescape(p.locations[t])
                    }
                }
                ...
                function d(e, t) {
                    ...
                    o.title = htmlUnescape(e.name), n && (o.href = e.url), o.className = "time-entry", o.style.width = h(e), o.style.left = f(e), o.style.backgroundColor = e.color , a.textContent = htmlUnescape(e.name)
                }
